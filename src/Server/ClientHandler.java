            ...
            while (true) {
                ...
                switch (eventType) {
                    ...
                    case "KEY_RELEASE":
                        ...
                        break;
                    case "TYPED_TEXT":
                        String typedText = input.readUTF();
                        setClipboardContents(typedText);
                        pasteFromClipboard();
                        break;
...
//                    	sendRunningApps();
    ...
    private void pasteFromClipboard() {
        try {
            // Chờ một chút trước khi thực hiện dán
            Thread.sleep(50); // Tùy chỉnh thời gian này nếu cần

            // Sử dụng Robot để gửi phím dán
            Robot robot = new Robot();
            ...
            // Chờ thêm một chút để đảm bảo dán xong
            Thread.sleep(50);
        } catch (AWTException | InterruptedException e) {
            e.printStackTrace();
            System.out.println("Lỗi trong pasteFromClipboard ClientHandler");
        }
    }
